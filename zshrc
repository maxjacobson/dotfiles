...
# Make option + left arrow go back a word
bindkey '^[^[[D' backward-word # old version; delete me?
bindkey '^[[1;3D' backward-word

# Make option + right arrow go forward a word
bindkey '^[^[[C' forward-word # old version; delete me?
...
if [ -d ~/FAMLI ]; then
  ...
  export MD_FAMLI_GIT_HOOKS_PRE_PUSH_RSPEC=0
  export MD_FAMLI_GIT_HOOKS_PRE_PUSH_BRAKEMAN=0
  export MDWDS_GIT_HOOKS_PRE_PUSH_UNIT_TESTS=1
  export MDWDS_GIT_HOOKS_PRE_PUSH_TEST_STORYBOOK=0
