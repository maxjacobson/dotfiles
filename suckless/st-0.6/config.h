 ...
 */
static char font[] = "Droid Sans Mono:pixelsize=18:antialias=false:autohint=false";
//static char font[] = "Courier Prime Code Regular:pixelsize=23:antialias=false:autohint=false";
