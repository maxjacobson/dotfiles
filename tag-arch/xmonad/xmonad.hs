...
myXmobarPP = def
  {
    ppCurrent = xmobarColor "#f442b3" "#99cc66"
    , ppHidden = xmobarColor "black" "#99cc66"
    , ppHiddenNoWindows = xmobarColor "white" "#99cc66" -- show all workspace numbers even if they're empty
    , ppUrgent = xmobarColor "red" "#99cc66"
    , ppWsSep = " "
